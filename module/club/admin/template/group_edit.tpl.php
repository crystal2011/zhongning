...
<div class="tt"><?php echo $action == 'add' ? '添加' : '修改';?>羊角会成员</div>
...
<tr>
<td class="tl"><span class="f_red">*</span> 羊角会成员名称</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 羊角会成员图标</td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 羊角会成员简介</td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 浏览羊角会成员</td>
<td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 羊角会成员状态</td>
<td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 羊角会成员模板</td>
...
<td><input type="text" size="22" name="post[filepath]" value="<?php echo $filepath;?>"/> <?php echo tips('限英文、数字、中划线、下划线、斜线，该羊角会成员相关的html文件将保存在此目录');?></td>
</tr>
<?php } ?>
</table>

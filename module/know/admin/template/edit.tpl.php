...
<td><input name="post[title]" type="text" id="title"  datatype="*2-50" size="60" value="<?php echo $title;?>"/> <?php echo level_select('post[level]', '级别', $level);?> <br/><span id="dtitle" class="f_red"></span></td>
</tr>
    <tr>

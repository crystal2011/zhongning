...
<td><?php echo tpl_select('compare', $module, 'setting[template_compare]', '默认模板', $template_compare);?></td>
</tr>
<tr>
<td class="tl">询价默认模板</td>
<td><?php echo tpl_select('inquiry', $module, 'setting[template_inquiry]', '默认模板', $template_inquiry);?></td>
</tr>
<tr>
...
<br/>用 | 分隔不同别名 依次对应 1|2|3|4|5|6|7|8|9 级 <?php echo level_select('post[level]', '提交后点此预览效果');?>
    ...
    <tr>
        <td class="tl">发布费用</td>
        <td><input name="setting[publishfee]" type="text" value="<?php echo isset($publishfee)?$publishfee:0;?>" size="10"/> 元</td>
    </tr>
    <tr>
        <td class="tl">置顶</td>

...
?>
    ...
    <br/>
    <form method="post" action="?moduleid=6&file=index&action=logadd&itemid=<?php echo $itemid; ?>">
...
<script>
    function dellog(itemid){
        if(confirm('您确定要删除该信息')){
            location.href = '?moduleid=6&file=index&action=logdel&itemid='+itemid;
        }
    }

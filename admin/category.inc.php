...
class category {
	...
	function update($category) {
		...
		foreach($category as $k=>$v) {
            ...
            $v['promote1'] = isset($v['promote1'])?intval($v['promote1']):0;
            $v['promote2'] = isset($v['promote2'])?intval($v['promote2']):0;
			...
			$this->db->query("UPDATE {$this->table} SET catname='$v[catname]',parentid='$v[parentid]',listorder='$v[listorder]',style='$v[style]',level='$v[level]',letter='$v[letter]',catdir='$v[catdir]',promote1='$v[promote1]',promote2='$v[promote2]' WHERE catid=$k ");
		}
		return true;
	}

...
<input name="category[<?php echo $v['catid'];?>][level]" type="text" value="<?php echo $v['level'];?>" size="1"/>
    ...
    <?php if($mid==21){ ?>
        <th><input type="checkbox" value="1" <?php echo $v['promote1']?'checked':''; ?> name="category[<?php echo $v['catid'];?>][promote1]" /></th>
        <th><input type="checkbox" value="1" <?php echo $v['promote2']?'checked':''; ?> name="category[<?php echo $v['catid'];?>][promote2]" /></th>
    <?php } ?>

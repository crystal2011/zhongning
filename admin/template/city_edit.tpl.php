...
<td class="tr"><?php echo ajax_area_select('post[areaid]', '请选择', $areaid,'',2);?> <span id="dareaid" class="f_red"></span></td>
</tr>
<tr>
...
<td><input name="post[name]" type="text" id="name" size="20" value="<?php echo $name;?>"/> <?php echo dstyle('post[style]', $style);?> <span id="dname" class="f_red"></span></td>
    ...
    <tr>
        <td class="tl"><span class="f_red">*</span> 分站拼音（唯一）</td>
        <td>
            <input name="post[pinyin]" type="text" id="pinyin" size="20" value="<?php echo $pinyin;?>" maxlength="20"/>
           &nbsp;只能输入小写a-z<span id="dpinyin" class="f_red"></span>
        </td>
    </tr>
<tr>
